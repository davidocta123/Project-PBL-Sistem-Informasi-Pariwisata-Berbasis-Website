...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
		<div class="container">
			<a class="navbar-brand" href="{{ asset('pages/user/home.blade.php')}}">BUNIHAYU<span>FOREST</span></a>
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item active"><a href="{{ asset('pages/user/home.blade.php')}}" class="nav-link">Home</a></li>
	...
	<div class="hero-wrap js-fullheight" style="background-image: url('{{ asset('frontend/images/gallery-18.jpg') }}');">
		<div class="overlay"></div>
		<div class="container">
			<div class="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
				<div class="col-md-7 ftco-animate">
					<span class="subheading">Selamat Datang di BUNIHAYU FOREST</span>
					<h1 class="mb-4">Private Glamping & Hot Spring Getaway</h1>
					<p class="caps">Manjakan diri Anda dan jelajahi Bunihayu Forest sambil menikmati pemandangan hijau, mendengar nyanyian merdu dari alam, sungai dan air terjun yang dapat menciptakan suasana yang menenangkan</p>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="container">
				<div class="row d-flex">
					<div class="col-md-6 order-md-last heading-section pl-md-5 ftco-animate d-flex align-items-center">
						<div class="w-100">
							<span class="subheading">Welcome to Buni Hayu</span>
							<h2 class="mb-4">Mulailah petualangan tak terlupakan di tengah keindahan alam</h2>
							<p>Saatnya memulai petualangan Anda di tengah keindahan alam yang menenangkan. Dikelilingi pepohonan hijau yang rimbun dan aliran sungai jernih yang mengalir tenang, tempat ini menjadi pilihan sempurna bagi Anda yang ingin melepas penat dari rutinitas sehari-hari. Nikmati udara segar pegunungan, suara gemericik air yang menenangkan, serta suasana alami yang menghadirkan ketenangan jiwa. Setiap sudut menawarkan keindahan dan kenyamanan, menjadikan perjalanan Anda tidak hanya sekadar liburan, tetapi juga pengalaman berharga untuk menyatu dengan alam dan menemukan kembali keseimbangan diri.</p>
							<p><a href="{{ route('user.glampi') }}" class="btn btn-primary py-3 px-4">Search Glamping</a></p>
						</div>
					</div>
					<div class="col-md-6">
						<div class="row">
		...
		<section class="ftco-section img ftco-select-destination" style="background-image: url('{{ asset('frontend/images/image-default.jpg') }}');">
			<div class="container">
				<div class="row justify-content-center pb-4">
					<div class="col-md-12 heading-section text-center ftco-animate">
						<span class="subheading">Buni Hayu</span>
						...
						<div class="carousel-destination owl-carousel ftco-animate">
							<div class="item">
								<div class="project-destination">
									<a href="#" class="img" style="background-image: url('{{ asset('frontend/images/gallery-31.jpg') }}');">
									</a>
								</div>
							</div>
							<div class="item">
							...
							<div class="item">
								<div class="project-destination">
									<a href="#" class="img" style="background-image: url('{{ asset('frontend/images/gallery-29.jpg') }}');">
									</a>
								</div>
							</div>
							<div class="item">
								<div class="project-destination">
									<a href="#" class="img" style="background-image: url('{{ asset('frontend/images/gallery-16.jpg') }}');">
									</a>
								</div>
							</div>
							<div class="item">
								<div class="project-destination">
									<a href="#" class="img" style="background-image: url('{{ asset('frontend/images/gallery-23.jpg') }}');">
									</a>
								</div>
							</div>
						</div>
    ...
    <div class="container">
        <div class="row justify-content-center pb-4">
            <div class="col-md-12 heading-section text-center ftco-animate">
                <span class="subheading">Glamping</span>
                <h2 class="mb-4">Glamping List</h2>
            </div>
        </div>
